...
export default function ContactPage() {
  ...
  const contactInfo = ["email", "phone", "visit"].map((k) => ({
    icon: t(lang, `contact.info.${k}.icon`), // keep icons configurable
  ...
  const testimonials = ["t1", "t2", "t3"].map((k, idx) => ({
    quote: t(lang, `contact.testimonials.${k}.quote`),
    author: t(lang, `contact.testimonials.${k}.author`),
    role: t(lang, `contact.testimonials.${k}.role`),
    image: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              {t(lang, "contact.testimonialsBlock.title")}
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">
              {t(lang, "contact.testimonialsBlock.subtitle")}
            </p>
          </AnimatedSection>
