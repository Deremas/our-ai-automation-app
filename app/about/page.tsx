...
//   const stats = [
//     { number: '10+', label: 'Businesses Automated' },
//     { number: '1M+', label: 'Tasks Processed' },
//     { number: '95%', label: 'Workflow Accuracy' },
...
//       description: 'Started with a vision to democratize AI automation for businesses'
//     },
//     {
//       year: '2021',
//       title: 'First Major Client',
//       description: 'Successfully automated invoice processing for a Fortune 500 company'
//     },
//     {
//       year: '2022',
//       title: 'AI Chatbot Launch',
//       description: 'Launched our revolutionary AI-powered chatbot platform'
//     },
//     {
//       year: '2023',
//       title: 'Predictive Analytics',
//       description: 'Introduced advanced predictive analytics capabilities'
//     },
//     {
//       year: '2024',
//       title: 'Global Expansion',
//       description: 'Expanded services to help businesses worldwide'
//     }
//   ];
...
//       <motion.div
//         ref={heroRef}
//         className="relative py-32 bg-gradient-to-br from-[#0e427e] to-[#0f437f] overflow-hidden z-10"
//         style={{
//           backgroundImage: `url('./images/page-bg.jpg')`,
//           backgroundSize: 'cover',
//           backgroundPosition: 'center',
...
//               transition={{ duration: 0.8, delay: 0.6 }}
//             >
//               We help businesses implement AI to automate tasks, improve decision-making, and accelerate growth through intelligent automation solutions.
//             </motion.p>
//           </motion.div>
//         </div>
//       </motion.div>
...
//               </h2>
//               <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
//                 We envision a world where artificial intelligence seamlessly integrates with human creativity to unlock unprecedented levels of productivity and innovation.
//               </p>
//               <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
//                 Our mission is to democratize AI automation, making advanced technology accessible to businesses of all sizes while maintaining the human touch that drives meaningful growth.
//               </p>
//               <div className="flex flex-wrap gap-4">
//                 {['AI Innovation', 'Process Optimization', 'Human-Centered Design'].map((tag, index) => (
//                   <motion.span
//                     key={index}
//                     className="px-6 py-3 bg-[#0e427e] text-white rounded-full text-sm font-medium"
//                     initial={{ opacity: 0, scale: 0 }}
...
//             </h2>
//             <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
//               From a small startup to a leading AI automation agency, here's how we've grown
//             </p>
//           </AnimatedSection>

//           <div className="relative">
//             <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-[#0e427e] dark:bg-[#f9b019] rounded-full"></div>
...
//                   <div className="flex-1 md:w-1/2 z-10">
//                     <motion.div
//                       className={`bg-white dark:bg-slate-700 rounded-xl p-8 shadow-lg mx-4 ${index % 2 === 0 ? 'md:mr-8 md:ml-0' : 'md:ml-8 md:mr-0'}`}
//                       whileHover={{
//                         scale: 1.05,
//                         y: -10,
//                         boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)"
...
//                       transition={{ duration: 0.3 }}
//                     >
//                       <div className="text-[#f9b019] font-bold text-xl mb-3">{item.year}</div>
...
//             </h2>
//             <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
//               Join the businesses that have already revolutionized their operations with AI automation
//             </p>
//             <motion.a
//               href="/contact"
//               className="inline-flex items-center px-10 py-5 bg-[#f9b019] text-white rounded-lg hover:bg-yellow-500 transition-all duration-200 font-medium text-lg shadow-lg hover:shadow-xl whitespace-nowrap"
