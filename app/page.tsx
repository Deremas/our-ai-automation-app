      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              { icon: 'ri-robot-line', number: '10+', label: 'Businesses Automated', color: 'bg-primary-500' },
              { icon: 'ri-flashlight-line', number: '95%', label: 'Workflow Accuracy', color: 'bg-accent-500' },
              { icon: 'ri-time-line', number: '24/7', label: 'Automated Operations', color: 'bg-primary-500' }
            ].map((stat, index) => (
              <motion.div
                key={index}
                className="space-y-6"
                initial={{ opacity: 0, y: 100 }}
                animate={statsInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 100 }}
                transition={{
                  duration: 0.8,
                  delay: index * 0.2,
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300 font-medium text-lg">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-20" delay={0.2}>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Join leading businesses that have transformed their operations with our AI automation solutions.
            </p>
          </AnimatedSection>
              ...
              >
                ...
                >
                  <div className="w-16 h-16 bg-gray-100 dark:bg-slate-700 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-primary-500 transition-colors duration-300">
                    <i className={`${client.logo} text-gray-600 dark:text-gray-300 group-hover:text-white text-2xl`}></i>
                  </div>
      ...
      <AnimatedSection className="py-32 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              From workflow automation to intelligent chatbots, we deliver AI solutions that drive real results.
            </p>
          </AnimatedSection>
      ...
      <AnimatedSection className="py-32 bg-gray-50 dark:bg-slate-800 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "AI automation reduced our email response time by 70% and freed up our team to focus on strategic initiatives.",
                author: "Sarah Johnson",
                role: "CEO, TechCorp",
                image: "/avatars/avataaars.svg"
              },
              {
                quote: "The workflow automation saved us 15 hours per week on invoice processing. ROI was immediate and truly impressive.",
                author: "Michael Chen",
                role: "Operations Manager, InnovateLabs",
                image: "/avatars/avataaars-3.svg"
              },
              {
                quote: "Our AI chatbot now handles 80% of customer queries instantly. Customer satisfaction has never been higher, all time high.",
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6 italic text-lg">"{testimonial.quote}"</p>
