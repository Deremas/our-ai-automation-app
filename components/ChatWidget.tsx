...
//       role: "assistant",
//       content:
//         "Hi! I'm your AI automation assistant for MFG Automation. Ask anything about AI integration, workflows, tools, or how we can automate your business.",
//     },
//   ]);
...
//     <>
//       {isOpen && (
//         <div className="fixed bottom-24 right-4 z-40 w-[380px] max-w-[95vw] h-[70vh] bg-white border border-gray-200 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
//           <div className="flex items-center justify-between px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
//             <div className="font-semibold text-sm">MFG AI Assistant</div>
//             <button
//               onClick={() => setIsOpen(false)}
...
//           <div className="flex-1 min-h-0 p-3 bg-slate-50 overflow-y-auto">
...
//       <button
//         onClick={() => setIsOpen((p) => !p)}
//         className="fixed bottom-2 right-4 z-50 flex items-center gap-2 rounded-full shadow-xl bg-[#0E427E] text-white px-4 py-3 hover:bg-[#1F6DCC]"
//         aria-label={isOpen ? "Close AI assistant" : "Open AI assistant"}
//       >
//         <span className="text-xl" aria-hidden="true">
//           AI
