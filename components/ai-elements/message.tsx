...
export function Message({
  ...
  return (
    <div
      className={from === "user" ? "flex justify-end" : "flex justify-start"}
    >
      <div className="max-w-[80%] rounded-2xl px-3 py-2 bg-white text-gray-900 border border-gray-200 shadow-sm">
        {children}
      </div>
    </div>
  );
